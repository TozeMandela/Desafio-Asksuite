...
var XhttpRequest = /*#__PURE__*/function () {
  function XhttpRequest() {
    _classCallCheck(this, XhttpRequest);
  }
  _createClass(XhttpRequest, null, [{
    key: "get",
    ...
    key: "Post",
    value: function Post(url, obj) {
      return this.GP('post', url, obj);
    }
  }, {
    key: "GP",
    value: function GP(Method, url, params) {
...
var XhttpRequest = __webpack_require__(/*! ./xhttprequest */ "./frontEnd/xhttprequest.js");
...
function ConvertToBase64(foto) {
  var photo = foto.files;
  if (photo.length > 0) {
    var file = new FileReader();
    file.onload = /*#__PURE__*/function () {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                document.getElementById('photo').value = _context.sent;
              case 3:
              case "end":
